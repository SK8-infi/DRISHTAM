...
from api.models import ClusterDetail
...
async def get_cluster_detail(cluster_id: int) -> ClusterDetail:
...
async def get_cluster_violations(cluster_id: int, limit: int = Query(50, ge=1, le=200)) -> dict:
